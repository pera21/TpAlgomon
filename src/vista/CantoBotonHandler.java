...
public class CantoBotonHandler implements EventHandler<ActionEvent>{
	...
	public CantoBotonHandler(PeleaAlgomonesScene escena, ControladorJuego controlador, TextArea consola, Algomon activo, Algomon inactivo){
	...
	public void handle(ActionEvent event) {
		...
		this.consola.appendText("-> " + this.algomonActivo.getNombreAlgomon() + " ataco a " + this.algomonInactivo.getNombreAlgomon() + " con canto y lo dejo dormido!.\n");
