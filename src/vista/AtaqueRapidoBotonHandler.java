...
public class AtaqueRapidoBotonHandler implements EventHandler<ActionEvent>{
	...
	public AtaqueRapidoBotonHandler(PeleaAlgomonesScene escena, ControladorJuego controlador, TextArea consola, Algomon activo, Algomon inactivo){
	...
	public void handle(ActionEvent event) {
		...
		this.consola.appendText("-> " + this.algomonActivo.getNombreAlgomon() + " ataco a " + this.algomonInactivo.getNombreAlgomon() + " con ataque rápido!.\n");
